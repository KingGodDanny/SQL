...
--Right Outer Join / Null을 가지고 있는 컬럼의 반대컬럼을 지정한다고 이해하기!
select em.employee_id 사번,
       em.first_name 이름,
       em.salary 급여,
       de.department_name 부서명,
...
--Left Outer Join / Null을 가지고 있는 컬럼의 반대컬럼을 지정한다고 이해하기!
select em.employee_id 사번,
       em.first_name 이름,
       em.salary 급여,
       de.department_name 부서명,
...
--Outer Join 약식방법 -->Null을 가지고있는 컬럼에 (+)해주는것 
select em.employee_id 사번,
       em.first_name 이름,
       em.salary 급여,
       de.department_name 부서명,
...
--출력하되 지역이름(오름차순), 나라이름(내림차순) 으로 정렬하세요. (25건)
...
from employees em,
     job_history joh
where joh.job_id = em.job_id
and em.job_id = 'AC_ACCOUNT';
