...
--함께 출력해 보세요. 두 임금의 차이는 얼마인가요?  “최고임금 – 최저임금”이란 타이틀로 함께 출력해 보세요.
...
--문제5. Group by 절 사용 , round(칼럼, -1 = 소수점에서 반올림하라)
...
--문제7.  Group by 절 이용시 having 절 사용
...
--문제9  Group by 절 이용시 having 절 사용과 where 절 사용 위치확인!!!
...
--문제10 Case ->When 조건 Then 출력 ->else ->End "컬럼명" 
